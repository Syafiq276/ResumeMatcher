        ...
        <div
            ...
            <div class="text-center mb-10 relative">
                ...
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight leading-tight">
                    Stop Guessing. <br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Start Interviewing.</span>
                </h1>
                <p class="text-slate-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                    Optimize your resume for <strong>Applicant Tracking Systems (ATS)</strong> in seconds. Our AI analyzes your resume against job descriptions to give you the competitive edge you deserve.
                </p>
            </div>
            ...
            <form action="{{ route('analyze') }}" method="POST" enctype="multipart/form-data" class="space-y-8"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <!-- Upload Section -->
                    <div class="space-y-2">
                        <label class="block text-sm font-medium text-slate-300 ml-1">Upload Resume</label>
                        <div class="relative group">
                            <input type="file" name="resume" id="resume"
                                class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" required />
                            <div
                                class="border-2 border-dashed border-slate-600 rounded-xl p-8 flex flex-col items-center justify-center text-center transition-all group-hover:border-blue-500 group-hover:bg-slate-800/50 bg-slate-800/30 h-64">
                                <div
                                    class="w-16 h-16 bg-slate-700/50 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                ...
                                <p class="text-slate-300 font-medium" id="file-name">Drag & drop or click to upload</p>
                                <p class="text-slate-500 text-sm mt-2">PDF or DOCX (Max 2MB)</p>
                            </div>
                        </div>
                    </div>
            ...
            @else
            <div class="bg-white/5 backdrop-blur-lg border border-white/10 p-8 md:p-12 rounded-2xl shadow-2xl text-center py-16">
                ...
                <p class="text-slate-300 text-lg mb-8 max-w-2xl mx-auto">
                    Join thousands of job seekers who are optimizing their applications with AI. Get <strong>detailed match reports</strong>, <strong>keyword gap analysis</strong>, and <strong>personalized improvement tips</strong>—all for free.
                </p>
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                     <a href="{{ route('register') }}" class="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-xl shadow-lg hover:shadow-blue-500/25 hover:scale-105 transition-transform flex items-center justify-center gap-2">
                        <span>Get Started for Free</span>
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
                    </a>
                    <a href="{{ route('login') }}" class="px-8 py-4 bg-slate-700/50 border border-slate-600 text-white font-bold rounded-xl hover:bg-slate-700 transition-colors flex items-center justify-center">
                        Log In
                    </a>
                </div>
            </div>
